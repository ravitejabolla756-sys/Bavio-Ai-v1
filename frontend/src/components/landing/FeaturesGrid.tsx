...
const features = [
  ...
  { icon: MessageSquare, title: "WhatsApp Alerts", desc: "Structured alerts with transcription summaries sent to your team." },
  { icon: Disc, title: "Call Summaries", desc: "Listen back to recordings and review conversations via dashboard." },
  { icon: Smile, title: "24×7 Availability", desc: "Fluent, natural, local accents active around the clock." },
  { icon: Terminal, title: "Custom Scripts", desc: "Provide your own custom script, greeting styles, and guidelines." },
  { icon: Languages, title: "Multi-language Support", desc: "Support for Hindi, English, and Hinglish accents." },
