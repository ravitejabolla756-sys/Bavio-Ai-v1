...
const INTEGRATION_LIST: IntegrationItem[] = [
  ...
  { name: "Twilio Trunking", category: "Telephony", desc: "Forward, buy, and manage custom business numbers through Twilio.", time: "5 mins", status: "Connected" },
  { name: "Exotel virtual", category: "Telephony", desc: "Sync calls and manage telecom routing with Exotel numbers.", time: "5 mins", status: "Not Connected" },
  { name: "Sarvam AI Voice", category: "Telephony", desc: "Stream speech packets via Sarvam low-latency Indian models.", time: "4 mins", status: "Connected" },
  { name: "Retell AI", category: "Telephony", desc: "Integrate Retell voice protocols for dedicated SIP trunk systems.", time: "5 mins", status: "Not Connected" },
  { name: "Vapi Voice", category: "Telephony", desc: "Connect Vapi pipelines to manage outbound automated dials.", time: "4 mins", status: "Not Connected" },
  ...
  { name: "ElevenLabs Voice", category: "Telephony", desc: "Sync natural accent synthesizers for Indian dialects.", time: "3 mins", status: "Connected" },
  { name: "Plivo Telephony", category: "Telephony", desc: "Rent Indian landline and toll-free numbers via Plivo APIs.", time: "4 mins", status: "Not Connected" },
