                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-[#6B5A4C] font-semibold font-mono">Co-Founder & CTO</span>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-[#6B5A4C] font-semibold font-mono">Co-Founder & Head of Product</span>
                    </div>
                  </div>
                  <p className="text-[#6B5A4C] text-sm leading-relaxed font-sans">
