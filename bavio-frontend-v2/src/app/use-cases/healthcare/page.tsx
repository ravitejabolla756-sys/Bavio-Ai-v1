          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
            <div className="lg:col-span-8 flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4 bg-surface border border-line rounded-3xl p-6 md:p-8">
                ...
                <p className="text-body-sm text-ink-tertiary leading-relaxed">
                  We isolate client transcripts on a tenant-by-tenant basis. Audio recordings are automatically purged after processing, and personal health details are stored on dedicated sovereign cloud servers in your chosen region.
                </p>
              </div>
            </div>
