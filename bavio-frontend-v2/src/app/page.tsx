...
const speechLines = [
  { text: "Hi there! This is Bavio, your AI voice agent.", time: 2 },
  { text: "I see you are inquiring about luxury condos downtown.", time: 5 },
  { text: "Your preferred budget is noted as $500K to $750K.", time: 8 },
  { text: "I have scheduled a showing for Saturday at 3 PM.", time: 11 },
  { text: "Confirmation details have been sent to your email. Thank you!", time: 14 },
];
...
const capabilities = [
  {
    ...
    description:
      "Sub-500ms latency. Natural, human-like conversations on any phone. Multilingual support available.",
  ...
  },
  {
    ...
    description:
      "English native with multilingual support. Spanish, French, and 10+ languages on the roadmap.",
    features: "Multilingual ready",
  },
];
                      ...
                      >
                        ...
                        <div className="w-full bg-surface-raised border border-line rounded-xl p-4 text-left flex flex-col gap-3 font-sans mt-2">
                          ...
                          <div className="flex justify-between border-b border-line-subtle pb-2 text-body-xs">
                            ...
                            <span className="font-semibold text-ink text-right">Property Inquiry (Luxury Condo)</span>
                          </div>
                          <div className="flex justify-between border-b border-line-subtle pb-2 text-body-xs">
                            <span className="text-ink-muted">Budget:</span>
                            <span className="font-semibold text-ink">$500K - $750K</span>
                          </div>
      ...
      <section className="relative border-y border-line-subtle bg-surface/50 py-16">
        <div className="max-w-container mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "English + Multilingual",
                desc: "Natural multilingual conversations built for global businesses.",
                icon: Translate,
              },
              {
