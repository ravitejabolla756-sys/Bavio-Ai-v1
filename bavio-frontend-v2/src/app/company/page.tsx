...
const values = [
  ...
  { icon: Flag, name: "Global-First", definition: "Built for businesses worldwide. Multilingual support is not an afterthought." },
];
...
const team = [
  {
    ...
    bio: "Built the AI voice infrastructure powering Bavio. Focused on scalable voice automation, conversational AI, and customer communication systems for businesses worldwide.",
        ...
        <div className="max-w-container mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            <ScrollReveal>
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  "Hiring receptionists costs $2,500 to $4,000 per month",
            ...
            <ScrollReveal delay={0.12}>
              ...
              <div className="flex flex-col gap-4">
                {[
                  "AI that understands English natively with multilingual support",
