...
export default function Careers() {
  const roles = [
    ...
    },
    {
      ...
      loc: "San Francisco, CA (Hybrid)",
      type: "Full-time",
      desc: "Train custom language and vocabulary models targeting regional dialects, accent variations, and multilingual code-switching parameters."
    },
    {
      ...
      <main className="flex-1 w-full relative flex flex-col items-center pt-28 pb-20">
        <section className="w-full max-w-4xl px-6 text-left">
          ...
          <p className="text-body-lg text-ink-tertiary mb-12 max-w-2xl leading-relaxed">
            We are building state-of-the-art voice qualification systems to help businesses capture every lead. Join us in San Francisco or remotely.
          </p>
