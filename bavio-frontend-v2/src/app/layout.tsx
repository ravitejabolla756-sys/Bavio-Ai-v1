...
export const metadata: Metadata = {
  ...
  description:
    "Answer every call instantly. Qualify leads automatically. 24/7 AI voice agents for businesses starting at $39 per month.",
  metadataBase: new URL("https://bavio.in"),
  openGraph: {
    title: "Bavio AI - Autonomous Voice Agents for Business Calls",
    description:
      "Answer every call instantly. Qualify leads automatically. 24/7 AI voice agents for businesses.",
    url: "https://bavio.in",
    siteName: "Bavio AI",
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Answer every call instantly. Qualify leads automatically with AI voice agents.",
  },
  robots: {
    index: true,
    follow: true,
